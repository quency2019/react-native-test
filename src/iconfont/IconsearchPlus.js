...
let IconsearchPlus = ({ size, color, ...rest }) => {
  return (
    <Svg viewBox="0 0 1027 1024" width={size} height={size} {...rest}>
      ...
      <Path
        ...
        fill={getIconColor(color, 1, '#73777A')}
      />
      <Path
        d="M398.222 227.556h56.89v398.222h-56.89z"
        fill={getIconColor(color, 2, '#73777A')}
      />
    </Svg>
  );
};

IconsearchPlus.defaultProps = {
  size: 18,
};

IconsearchPlus = React.memo ? React.memo(IconsearchPlus) : IconsearchPlus;
